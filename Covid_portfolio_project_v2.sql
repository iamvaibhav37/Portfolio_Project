--SHow the likelihood of dying if you get covid in India
...
--Shows what percentage of population got the COVID, creating index for faster calculation
...
--highest percentage infected for each country
...
--(this query is giving us the max of total death in a country in a continent, e.g. NorthAMerica here only shows about the US data)
